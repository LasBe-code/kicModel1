...
int boardcount;
int pageInt = 1; // 페이지 넘버
int limit = 10; // 한 페이지에 표시한 게시글 수
...
//-----------------------------------------------
boardcount = bd.boardCount(boardid);
...
if(boardid.equals("1")) boardName = "공지사항";
if(boardid.equals("2")) boardName = "자유게시판";
if(boardid.equals("3")) boardName = "QnA";
	...
	<div class="container">
		...
		<div class="container"  >
			<ul class="pagination justify-content-center"  >
   				<li class="page-item<% if(startPage <= bottomLine){%>disable<%}%> "><a class="page-link" href="list.jsp?pageNum=<%=startPage-bottomLine%>">Previous</a></li>
  				<%for(int i=startPage;i<=endPage;i++){ %>
  					<li class="page-item <%if(i==pageInt){%>active<%}%>"><a class="page-link" href="list.jsp?pageNum=<%=i%>"><%=i %></a></li>
  				<%} %>
  				<li class="page-item<% if(endPage >= maxPage){%>disable<%}%> " ><a class="page-link" href="list.jsp?pageNum=<%=startPage+bottomLine%>">Next</a></li>
			</ul> 
		</div>
	</div>
</body>
